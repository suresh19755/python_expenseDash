...
if 'expenses' not in st.session_state:
    initial_data = {
        "Date": [datetime.date(2023, 10, 1), datetime.date(2023, 10, 2), datetime.date(2023, 10, 3), datetime.date(2023, 10, 5)],
...
budget = st.slider("Monthly Budget Goal ($)", 100, 5000, 1000)
...
col2.metric("Budget Goal", f"${budget}")
